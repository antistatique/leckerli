...
if (window.leckerliSettings.enableGtmAutoLoad) {
  ...
  leckerliStyles.href = `//www.unpkg.com/@antistatique/leckerli@${APP_VERSION}/dist/leckerli.min.css`;
...
if (window.leckerliSettings.enableGtmAutoLoad) {
  ...
  leckerliScript.src = `//www.unpkg.com/@antistatique/leckerli@${APP_VERSION}/dist/leckerli.min.js`;
